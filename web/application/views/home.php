				...
				<div id="container"  class="module_content" style="height:330px">
					...
					<table style="padding-top:1.5cm" width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr >
					    ...
					    <td align="center"><a href=<?php echo SERVER_BASE_URL.lang('cobub_login_ucenter')."/cobubtologin/$key/$secret" ?> target="_blank" ><img src="<?php echo base_url();?>assets/images/usercenter.png" /></a></td>
					   <?php endif;?>
					   <?php if(!isset($key) && !isset($secret)):?>
					    <td align="center"><a href=<?php echo SERVER_BASE_URL.lang('cobub_login_ucenter')."/login" ?> target="_blank" ><img src="<?php echo base_url();?>assets/images/usercenter.png" /></a></td>
					   <?php endif;?>
					  </tr>
					  <tr>
